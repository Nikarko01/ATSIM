    ...
    if (Z2Si.gt.0.0_dp) then
      ...
      if (lgrad1) then
        ...
        if (lgrad2) then
          ...
          d2rhoidr2 = (drhoi2sdr/sqrt(rhoi2s) + drhoi20_2NNdr/sqrt(rhoi20_2NN))**2 + &
    ...
    if (Z2Sj.gt.0.0_dp) then
      ...
      if (lgrad1) then
        ...
        if (lgrad2) then
          ...
          d2rhojdr2 = (drhoj2sdr/sqrt(rhoj2s) + drhoj20_2NNdr/sqrt(rhoj20_2NN))**2 + &
      ...
      if (Z2Si.gt.0.0_dp) then
        ...
        if (lgrad1) then
          ...
          if (lgrad2) then
            ...
            d2rhoi20dr2 = (drhoi20sdr/sqrt(rhoi20s) + drhoi20_2NNdr/sqrt(rhoi20_2NN))**2 + &
      ...
      if (Z2Sj.gt.0.0_dp) then
        ...
        if (lgrad1) then
          ...
          if (lgrad2) then
            ...
            d2rhoj20dr2 = (drhoj20sdr/sqrt(rhoj20s) + drhoj20_2NNdr/sqrt(rhoj20_2NN))**2 + &
