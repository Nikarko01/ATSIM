...
!
!  Correct indices for cell wrapping during spatial setup
!
              ixi = ixi - icosxsp(i)
              iyi = iyi - icosysp(i)
              izi = izi - icoszsp(i)
...
!  Correct indices for cell wrapping during spatial setup
!
                        ijcx = ijcx + (icosxsp(j) - icosxsp(i))
                        ijcy = ijcy + (icosysp(j) - icosysp(i))
                        ijcz = ijcz + (icoszsp(j) - icoszsp(i))
!
                        if (lbtyp) then
...
!  Correct indices for cell wrapping during spatial setup
!
                                ikcx = ikcx + (icosxsp(k) - icosxsp(i))
                                ikcy = ikcy + (icosysp(k) - icosysp(i))
                                ikcz = ikcz + (icoszsp(k) - icoszsp(i))
!
                                if (lbtyp) then
...
!  Correct indices for cell wrapping during spatial setup
!
                                          ilcx = ilcx + (icosxsp(l) - icosxsp(i))
                                          ilcy = ilcy + (icosysp(l) - icosysp(i))
                                          ilcz = ilcz + (icoszsp(l) - icoszsp(i))
!
                                          if (lbtyp) then
...
!  Correct indices for cell wrapping during spatial setup
!
                                                  jmcx = jmcx + (icosxsp(m) - icosxsp(j))
                                                  jmcy = jmcy + (icosysp(m) - icosysp(j))
                                                  jmcz = jmcz + (icoszsp(m) - icoszsp(j))
!
                                                  if (lbtyp) then
...
!  Correct indices for cell wrapping during spatial setup
!
                                                            jncx = jncx + (icosxsp(n) - icosxsp(j))
                                                            jncy = jncy + (icosysp(n) - icosysp(j))
                                                            jncz = jncz + (icoszsp(n) - icoszsp(j))
!
                                                            if (lbtyp) then
