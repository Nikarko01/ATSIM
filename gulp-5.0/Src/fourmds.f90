...
!  Correct indices for cell wrapping during spatial setup
!
                    jkcx = jkcx + (icosxsp(k) - icosxsp(j))
                    jkcy = jkcy + (icosysp(k) - icosysp(j))
                    jkcz = jkcz + (icoszsp(k) - icoszsp(j))
!
                    if (lanybtyp) then
...
!  Correct indices for cell wrapping during spatial setup
!
                              jicx = jicx + (icosxsp(i) - icosxsp(j))
                              jicy = jicy + (icosysp(i) - icosysp(j))
                              jicz = jicz + (icoszsp(i) - icoszsp(j))
!
                              if (lbtyp) then
...
!  Correct indices for cell wrapping during spatial setup
!
                                      klcx = klcx + (icosxsp(l) - icosxsp(k))
                                      klcy = klcy + (icosysp(l) - icosysp(k))
                                      klcz = klcz + (icoszsp(l) - icoszsp(k))
!
                                      if (lbtyp) then
