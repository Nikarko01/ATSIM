...
!
    if (nfloat.ge.7) then
      ...
      BOncoeffR(nboR) = floats(3+nbeg)
      BOlcoeffR(nboR) = floats(4+nbeg)
      BOccoeffR(1,nboR) = floats(5+nbeg)
      BOccoeffR(2,nboR) = floats(6+nbeg)
...
!
    if (nfloat.ge.10) then
      ...
      BOccoeffR(1,nboR) = floats(5+nbeg)
      BOccoeffR(2,nboR) = floats(6+nbeg)
      BOccoeffR(3,nboR) = floats(7+nbeg)
      BOccoeffR(4,nboR) = floats(8+nbeg)
      BOccoeffR(5,nboR) = floats(9+nbeg)
      BOhcoeffR(nboR) = floats(10+nbeg)
...
!
    if (nfloat.ge.7) then
      ...
      BOncoeffA(nboA) = floats(3+nbeg)
      BOlcoeffA(nboA) = floats(4+nbeg)
      BOccoeffA(1,nboA) = floats(5+nbeg)
      BOccoeffA(2,nboA) = floats(6+nbeg)
...
!
    if (nfloat.ge.10) then
      ...
      BOccoeffA(1,nboA) = floats(5+nbeg)
      BOccoeffA(2,nboA) = floats(6+nbeg)
      BOccoeffA(3,nboA) = floats(7+nbeg)
      BOccoeffA(4,nboA) = floats(8+nbeg)
      BOccoeffA(5,nboA) = floats(9+nbeg)
      BOhcoeffA(nboA) = floats(10+nbeg)
    elseif (nfloat.eq.9) then
      BOecoeffA(nboA) = floats(1+nbeg)
      BOmcoeffA(nboA) = 3.0_dp
      BOncoeffA(nboA) = floats(2+nbeg)
