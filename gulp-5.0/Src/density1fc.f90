...
!
              ...
              zik0 = zclat(k) - zal
!
!  Correct for displacements if matom = k or i
!
              if (k.eq.matom) then
                xik0 = xik0 + (vmatom(1) - xclat(k))
                yik0 = yik0 + (vmatom(2) - yclat(k))
                zik0 = zik0 + (vmatom(3) - zclat(k))
              elseif (i.eq.matom) then
                xik0 = xik0 - (vmatom(1) - xclat(i))
                yik0 = yik0 - (vmatom(2) - yclat(i))
                zik0 = zik0 - (vmatom(3) - zclat(i))
              endif
!
              xjk0 = xik0 - xtmp(l)
              yjk0 = yik0 - ytmp(l)
