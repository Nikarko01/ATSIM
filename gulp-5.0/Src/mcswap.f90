...
!****************************
    do ns = 1,nmcswappair(nswap2try)
      x1 = x0(3*nptrswap1(ns)+nstrains-2)
      y1 = x0(3*nptrswap1(ns)+nstrains-1)
      z1 = x0(3*nptrswap1(ns)+nstrains)  
      x2 = x0(3*nptrswap2(ns)+nstrains-2)
      y2 = x0(3*nptrswap2(ns)+nstrains-1)
      z2 = x0(3*nptrswap2(ns)+nstrains)  
!
      x0(3*nptrswap1(ns)+nstrains-2) = x2
      x0(3*nptrswap1(ns)+nstrains-1) = y2
      x0(3*nptrswap1(ns)+nstrains)   = z2
      x0(3*nptrswap2(ns)+nstrains-2) = x1
      x0(3*nptrswap2(ns)+nstrains-1) = y1
      x0(3*nptrswap2(ns)+nstrains)   = z1
    enddo
