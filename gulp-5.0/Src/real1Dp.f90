...
!  Real terms
!
      derv2(ix,ix) = derv2(ix,ix) + d2*d2h1(1)*cos2k
      derv2(iy,ix) = derv2(iy,ix) + d2*d2h1(6)*cos2k
      derv2(iz,ix) = derv2(iz,ix) + d2*d2h1(5)*cos2k
      derv2(ix,iy) = derv2(ix,iy) + d2*d2h1(6)*cos2k
      derv2(iy,iy) = derv2(iy,iy) + d2*d2h1(2)*cos2k
      derv2(iz,iy) = derv2(iz,iy) + d2*d2h1(4)*cos2k
      derv2(ix,iz) = derv2(ix,iz) + d2*d2h1(5)*cos2k
      derv2(iy,iz) = derv2(iy,iz) + d2*d2h1(4)*cos2k
      derv2(iz,iz) = derv2(iz,iz) + d2*d2h1(3)*cos2k
!
!  Group velocities
!  
      if (lgroupvelocity) then
