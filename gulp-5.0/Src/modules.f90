...
!
  module gulp_files
    ...
    character(len=80), save :: inertfile
    character(len=80), save :: kptfile
...
!
  module fitting
    ...
    character(len=15),                    save :: fitlabel(28,59,9)
    character(len=10),                    save :: fitlabelunits(28,59,9)
    integer(i4),                          save :: nfitlabel(59,9)
...
!
  module frequencies
    ...
    integer(i4),                                 save :: maxfqat = 1         ! Maximum left hand dimension(s) of freq & eigv
...
!
  module optimisation
    ...
    integer(i4),                          save :: nfixatom                ! Number of fixed atom
    ...
    real(dp),                             save :: stepmaxrfo           ! Maximum step size for RFO
...
!
  module potentialnames
    use datatypes
    integer(i4),                          save :: max2pottype = 59
    integer(i4),                          save :: max3pottype = 24
    integer(i4),                          save :: max4pottype = 17
    character(len=13),                    save :: name2pot(59)             ! Names of twobody potentials
    character(len=13),                    save :: name3pot(25)             ! Names of threebody potentials
...
!
  module thresholds
    use datatypes
    real(dp), save :: thresh_fc3_ind = 0.00001_dp         ! Threshold on third order force constants - individual value
    real(dp), save :: thresh_fc3_tot = 0.001_dp           ! Threshold on third order force constants - largest value in block
