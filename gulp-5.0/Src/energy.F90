...
!  12/15 Argument to setspatial subroutines changed to false otherwise
!        finite difference calls fail.
...
!*************************
  if (lDoQDeriv1.or.latomicstress.or.lsiteenergy) lspmeloc = .false.
!**************************************
