...
!
!  Julian Gale, CIC, Curtin University, December 2016
!
...
!
            derv2dk(1:3,jx,ix) = derv2dk(1:3,jx,ix) - cdk(1:3)*dcmplx(rpd(k,1),0.0_dp)
            derv2dk(1:3,jy,ix) = derv2dk(1:3,jy,ix) - cdk(1:3)*dcmplx(rpd(k,6),0.0_dp)
            derv2dk(1:3,jz,ix) = derv2dk(1:3,jz,ix) - cdk(1:3)*dcmplx(rpd(k,5),0.0_dp)
            derv2dk(1:3,jx,iy) = derv2dk(1:3,jx,iy) - cdk(1:3)*dcmplx(rpd(k,6),0.0_dp)
            derv2dk(1:3,jy,iy) = derv2dk(1:3,jy,iy) - cdk(1:3)*dcmplx(rpd(k,2),0.0_dp)
            derv2dk(1:3,jz,iy) = derv2dk(1:3,jz,iy) - cdk(1:3)*dcmplx(rpd(k,4),0.0_dp)
            derv2dk(1:3,jx,iz) = derv2dk(1:3,jx,iz) - cdk(1:3)*dcmplx(rpd(k,5),0.0_dp)
            derv2dk(1:3,jy,iz) = derv2dk(1:3,jy,iz) - cdk(1:3)*dcmplx(rpd(k,4),0.0_dp)
            derv2dk(1:3,jz,iz) = derv2dk(1:3,jz,iz) - cdk(1:3)*dcmplx(rpd(k,3),0.0_dp)
!
