...
#ifdef KIM
  use kim_models,    only : kim_test_descriptor
#endif
  use ksample
  use kspace,        only : maxindk, maxindk2, maxindk3, accf1D
  use library
...
!
  ...
  third = 1.0_dp/3.0_dp
  thresh_fc3_ind = 0.00001_dp
  thresh_fc3_tot = 0.001_dp
  timesofar = 0.0_dp
  xtol = 0.00001_dp
  velmax = 100.0_dp
  ichemsh_output = 0
...
!-------------------------
  ...
  fitlabel(8,1,6) ='B-O rep C / C1'
  fitlabel(9,1,6) ='B-O rep D / C2'
  fitlabel(10,1,6)='B-O rep H     '
  fitlabel(11,1,6)='B-O rep C3    '
  fitlabel(12,1,6)='B-O rep C4    '
  fitlabel(13,1,6)='B-O rep C5    '
  fitlabel(14,1,6)='B-O att Alpha '
  fitlabel(15,1,6)='B-O att N     '
  fitlabel(16,1,6)='B-O att Lambda'
  fitlabel(17,1,6)='B-O att C     '
  fitlabel(18,1,6)='B-O att D     '
  fitlabel(19,1,6)='B-O att H     '
  fitlabel(20,1,6)='B-O att C3    '
  fitlabel(21,1,6)='B-O att C4    '
  fitlabel(22,1,6)='B-O att C5    '
  fitlabel(23,1,6)='B-O rep chi   '
  fitlabel(24,1,6)='B-O att chi   '
  fitlabel(25,1,6)='B-O cn C1     '
  fitlabel(26,1,6)='B-O cn C2     '
  fitlabel(27,1,6)='B-O cn Z0     '
  fitlabel(28,1,6)='B-O cn E0     '
