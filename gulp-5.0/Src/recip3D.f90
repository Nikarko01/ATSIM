          ...
          if (lgrad2) then
            ...
            do j = 1,i-1
              ...
              if (.not.lfreeze.or.lopi.or.lopj) then
                ...
                derv2(jxc,ixc) = derv2(jxc,ixc) + argck*tmps(1)
                derv2(jyc,iyc) = derv2(jyc,iyc) + argck*tmps(2)
                derv2(jzc,izc) = derv2(jzc,izc) + argck*tmps(3)
                derv2(jyc,ixc) = derv2(jyc,ixc) + argck*tmps(6)
                derv2(jzc,ixc) = derv2(jzc,ixc) + argck*tmps(5)
                derv2(jzc,iyc) = derv2(jzc,iyc) + argck*tmps(4)
              endif
            enddo
          endif
!
