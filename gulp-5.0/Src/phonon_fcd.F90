...
!
  lused1 = (lnoanald2loc.or.lfinitediff) 
!
...
!
            ...
            if (lpartofdisp) then
              call nagamma(nphonatc,nphonatc,iocptr,rmass,bornkloc,maxd2,derv2)
            else
              call nagamma(nphonatc,nphonatc,iocptr,rmass,bornk(1,ncf),maxd2,derv2)
            endif
          endif
!
...
!  Non-analytic correction for gamma point
!
              call nagamma(nphonatc,nphonatc,iocptr,rmass,qfrac,maxd2,derv2)
!
!  Calculate eigenvalues and eigenvectors of corrected dynamical matrix
!
              call pdiaggd(mcv,mcvloc,maxd2,derv2,maxeigr,eigr,freq(1,k-nlkpt+1),fscale,.true.,lprint,ifail)
...
!
              ...
              if (lpartofdisp) then
                call nagammac(nphonatc,nphonatc,nphonatptr,iocptr,rmass,bornkloc,maxd2,derv2,dervi,xkt,ykt,zkt)
              else
                call nagammac(nphonatc,nphonatc,nphonatptr,iocptr,rmass,bornk(1,ncf),maxd2,derv2,dervi,xkt,ykt,zkt)
              endif
            endif
!
!  Calculate eigenvalues and eigenvectors of corrected dynamical matrix
...
!  Non-analytic correction for gamma point
!
                call nagammac(nphonatc,nphonatc,nphonatptr,iocptr,rmass,qfrac,maxd2,derv2,dervi,xkt,ykt,zkt)
!
!  Calculate eigenvalues and eigenvectors of corrected dynamical matrix
!
                call pdiagd(mcv,mcvloc,maxd2,derv2,dervi,maxeigc,eigc,freq(1,k-nlkpt+1),fscale,.true.,lprint,ifail)
