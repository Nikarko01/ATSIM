...
!
  ...
  use control
  use current
  use derivatives,   only : xdrv, ydrv, zdrv, lfcsupercell
...
!
    if (lmain.and..not.lharmloc) call optin(lhess2D)
!
!  Start minimisation
!
...
!
      call harmonicrelax(xc,fc,gc,hess(1,1),nhwords,lhess2D,1_i4,lfree)
      ifail = 4
      loptsuccess = .true.
