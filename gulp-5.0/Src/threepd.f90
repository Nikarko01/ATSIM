...
!
                  d2k  = ed11*cos12
                  d2ks = ed11*sin12
                  cdk12(1) = dcmplx(d2k*xt21,d2ks*xt21)*dcmplx(0.0_dp,1.0_dp)
                  cdk12(2) = dcmplx(d2k*yt21,d2ks*yt21)*dcmplx(0.0_dp,1.0_dp)
                  cdk12(3) = dcmplx(d2k*zt21,d2ks*zt21)*dcmplx(0.0_dp,1.0_dp)
!
                  d2k  = ed12*cos13
                  d2ks = ed12*sin13
                  cdk13(1) = dcmplx(d2k*xt31,d2ks*xt31)*dcmplx(0.0_dp,1.0_dp)
                  cdk13(2) = dcmplx(d2k*yt31,d2ks*yt31)*dcmplx(0.0_dp,1.0_dp)
                  cdk13(3) = dcmplx(d2k*zt31,d2ks*zt31)*dcmplx(0.0_dp,1.0_dp)
!
...
!
                  d2k  = ed13*cos23
                  d2ks = ed13*sin23
                  cdk23(1) = dcmplx(d2k*x23,d2ks*x23)*dcmplx(0.0_dp,1.0_dp)
                  cdk23(2) = dcmplx(d2k*y23,d2ks*y23)*dcmplx(0.0_dp,1.0_dp)
                  cdk23(3) = dcmplx(d2k*z23,d2ks*z23)*dcmplx(0.0_dp,1.0_dp)
!
