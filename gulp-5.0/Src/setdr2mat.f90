...
!
!  Julian Gale, Curtin University, June 2017
!
  use control
  use current
  use derivatives
...
20    rewind(44)
    ...
    if (nprocs.gt.1) then
      call sendall(derv3(1,1),3_i4*numat,ioproc,"setdr2mat","derv3")
      call sendall(derv3(1,2),3_i4*numat,ioproc,"setdr2mat","derv3")
      call sendall(derv3(1,3),3_i4*numat,ioproc,"setdr2mat","derv3")
