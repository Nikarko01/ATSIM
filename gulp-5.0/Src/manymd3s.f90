...
!
                        if (nptype(npot).eq.45.or.nptype(npot).eq.55) then
                          ...
                          if (lstr) then
                            derivs(1) = derivs(1) + d1bas*xji*xji*Sij
                            derivs(2) = derivs(2) + d1bas*yji*yji*Sij
                            derivs(3) = derivs(3) + d1bas*zji*zji*Sij
                            derivs(4) = derivs(4) + d1bas*yji*zji*Sij
                            derivs(5) = derivs(5) + d1bas*xji*zji*Sij
                            derivs(6) = derivs(6) + d1bas*xji*yji*Sij
                          endif
!
