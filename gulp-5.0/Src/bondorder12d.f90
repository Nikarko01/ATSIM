...
!
            if (bijsumA.gt.0.0_dp) then
              ...
              rtmp = 0.25_dp*zAi3*bijA*rbijsumA1*(zAi3*(1.0_dp + 0.5_dp/BOncoAij)*(bijsumAn1**2.0_dp)* &
                BOncoAij*rbijsumA1 - ((BOncoAij-1)*bijsumA**(BOncoAij-2)))
              nn = 0 
              do nn1 = 1,nneighi2
                do nn2 = 1,nn1
                  nn = nn + 1
            ...
            if (bijsumR.gt.0.0_dp) then
              ...
              rtmp = 0.25_dp*zRi3*bijR*rbijsumR1*(zRi3*(1.0_dp + 0.5_dp/BOncoRij)*(bijsumRn1**2.0_dp)* &
                BOncoRij*rbijsumR1 - ((BOncoRij-1)*bijsumR**(BOncoRij-2)))
              nn = 0 
              do nn1 = 1,nneighi2
                do nn2 = 1,nn1
                  nn = nn + 1
...
!
  if (.not.lgrad2) then
    call sumall(ebondorder,esum,1_i4,"bondorder12d","ebondorder")
    ebondorder = esum
  endif
!
!  Free local memory
