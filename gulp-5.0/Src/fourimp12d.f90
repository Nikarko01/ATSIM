...
!********************************
  jloop2:  do j = procid+1,ntreg2,nprocs
    ...
    npsj = nps(j)
    if (.not.lmatchany(nj,ntypj,nmiddle,natmiddle,ntypmiddle)) cycle jloop2
!***************************************
!  Loop over second middle site 3 / k  *
!***************************************
    kloop2: do k = 1,ntot
      ...
      if (.not.lmatchany(nk,ntypk,nmiddle,natmiddle,ntypmiddle)) cycle kloop2
      if (.not.lmatchpair(nj,ntypj,nk,ntypk,nfor,nfspec2,nfptyp2,nfspec3,nfptyp3)) cycle kloop2
!
      x32 = xc3 - xc2
      y32 = yc3 - yc2
      z32 = zc3 - zc2
...
!********************************
  jloop3:  do j = 1,ntot
    ...
    if (.not.lmatchany(nj,ntypj,nmiddle,natmiddle,ntypmiddle)) cycle jloop3
!***************************************
!  Region 1 for k :                    *
!  Loop over second middle site 3 / k  *
!***************************************
    kloop3: do kloc = lpmin,lpmax,nproclp
      ...
      if (.not.lmatchany(nk,ntypk,nmiddle,natmiddle,ntypmiddle)) cycle kloop3
      if (.not.lmatchpair(nj,ntypj,nk,ntypk,nfor,nfspec2,nfptyp2,nfspec3,nfptyp3)) cycle kloop3
!
      x32 = xc3 - xc2
      y32 = yc3 - yc2
      z32 = zc3 - zc2
...
!***************************************
    kloop4: do k = 1,ntot
      ...
      if (.not.lmatchany(nk,ntypk,nmiddle,natmiddle,ntypmiddle)) cycle kloop4
      if (.not.lmatchpair(nj,ntypj,nk,ntypk,nfor,nfspec2,nfptyp2,nfspec3,nfptyp3)) cycle kloop4
!
      x32 = xc3 - xc2
      y32 = yc3 - yc2
      z32 = zc3 - zc2
